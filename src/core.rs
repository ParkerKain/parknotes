...
pub fn detect_root_folder(config: &Config) -> bool {
...
///
/// * `config` - a reference to a config object
pub fn create_root_folder(config: &Config) {
...
///
/// * `config` - a reference to a config object
pub fn create_objects(config: &Config) -> (Vec<Note>, Vec<Project>) {
...
pub fn create_new_note(config: &Config, orig_note_name: String, project_path: PathBuf) -> PathBuf {
...
/// * `config` - the config file that controls the run
/// * `orig_note_name` - the original intended name of the new note
pub fn create_new_project(config: &Config, project_name: String) {
...
pub fn delete(full_path: PathBuf) -> bool {
